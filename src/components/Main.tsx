    ...
    <div className='flex flex-col gap-y-4'>
      <div className='self-center flex justify-between mt-5 pb-5 gap-8 w-11/12'>
        ...
        <div className='flex items-center justify-end gap-x-3'>
            ...
            <input className='bg-transparent border-2 rounded-full text-lg text-white px-5 py-2' value={searchItem} onChange={handleInputChange} placeholder='Search hue...' type="text" name="search" id="search"/>
        </div>
      </div>
